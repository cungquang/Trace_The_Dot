...
void I2cbus1Write_No0(void)
{
    ...
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_0);
}

void I2cbus1Write_No1(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_1);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_1);
}

void I2cbus1Write_No2(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_2);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_2);
}

void I2cbus1Write_No3(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_3);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_3);
}

void I2cbus1Write_No4(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_4);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_4);
}

void I2cbus1Write_No5(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_5);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_5);
}

void I2cbus1Write_No6(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_6);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_6);
}

void I2cbus1Write_No7(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_7);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_7);
}

void I2cbus1Write_No8(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_8);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_8);
}

void I2cbus1Write_No9(void)
{
    writeI2cReg(i2c1_FileDesc, REG_DIRA, OXOO_9);
    writeI2cReg(i2c1_FileDesc, REG_DIRB, OXO1_9);
}
